            ...
            <div id="docs" className="mx-auto max-w-7xl px-6">
              ...
              <div className="grid md:grid-cols-3 gap-8 text-center">
                ...
                <div className="relative p-8 group">
                  ...
                  <p className="text-sm text-slate-400">Provide liquidity to NFT collections on DEX Pools, earn fees &amp; incentives.</p>
                </div>
          ...
          <footer className="mt-40 border-t border-white/5 bg-slate-950 px-6 py-16">
            <div className="mx-auto max-w-6xl grid gap-12 md:grid-cols-4">
              ...
              <div>
                ...
                <ul className="space-y-3 text-sm text-slate-400">
                  <li>
                    <a href="https://docsend.com/view/5zhvqdsivx2avxkg" target="_blank" rel="noopener noreferrer" className="hover:text-orange-500 transition-colors">
                      Pitch Deck
                    </a>
                  </li>
                  <li>
                    <a href="https://sweep-n-flip.gitbook.io/documentation" target="_blank" rel="noopener noreferrer" className="hover:text-orange-500 transition-colors">
                      Gitbook Docs
                    </a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="#" className="hover:text-orange-500 transition-colors">Media Kit</a>
                  </li>
                </ul>
              </div>
            </div>
